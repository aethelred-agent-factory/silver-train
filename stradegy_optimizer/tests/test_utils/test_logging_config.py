...
import logging
import os
from src.utils.logging_config import setup_logging, create_default_logging_config
...
def test_setup_logging_without_file_uses_defaults(tmp_path, caplog):
    ...
    assert "Failed to load logging configuration file. Using default configs" in caplog.text
