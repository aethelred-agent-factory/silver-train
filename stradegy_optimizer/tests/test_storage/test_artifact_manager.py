...
def test_download_artifact_local_not_found(local_artifact_manager):
    downloaded_data, checksum = local_artifact_manager.download_artifact("non_existent.json")
    assert downloaded_data is None
    assert checksum is None

def test_download_artifact_local_checksum_mismatch(local_artifact_manager, tmp_path, crypto_utils):
