...
class DataValidator:
    ...
    def detect_gaps(self, data: pd.DataFrame, expected_freq='1H') -> pd.DataFrame:
        """
    ...
    def validate_and_impute(self, symbol: str, start_date: str, end_date: str, expected_freq='1H') -> pd.DataFrame:
        """
