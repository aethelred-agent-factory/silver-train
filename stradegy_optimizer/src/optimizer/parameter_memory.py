...
class ParameterMemory:
    ...
    def __init__(self, state_manager=None):
        ...
        self.blacklist_set = set()  # Set of blacklisted parameter hashes (renamed to avoid conflict with method name)
    ...
    def log_tested(self, params: dict, regime: str, metrics: Dict = None, result: str = 'TESTED'):
        """
        ...
        logging.info(f"Logging tested params {params_hash} for {regime}: "
    ...
    def record_best_params(self, regime: str, params: Dict, metrics: Dict, iteration: int) -> None:
        """
        ...
        logging.info(f"Recording best params for {regime}: profit={profit_pct:.2f}%, dd={max_drawdown_pct:.2f}%")
    ...
    def blacklist(self, params_hash: str, params: Dict = None, reason: str = "") -> None:
        """
        ...
        params_json = json.dumps(params, sort_keys=True, default=str) if params else None
