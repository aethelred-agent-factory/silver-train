...
class HealthChecker:
    ...
    def __init__(self, config, state_manager, exchange_adapter, alerting):
        ...
        self.health_check_interval = config['system_config']['monitoring']['health_check_interval']
    ...
    def start_periodic_checks(self):
        ...
        """
        logging.info(f"Starting periodic health checks every {self.health_check_interval} seconds.")
        while True:
            self.run_checks()
