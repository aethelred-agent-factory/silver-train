...
def execution_engine(
    test_config, mock_order_manager, mock_state_manager, mock_portfolio_state
):
...
def test_execute_trade_blocked_by_kill_switch(
    execution_engine, mock_state_manager, mock_order_manager
):
