...
class BacktestEngine:
            ...
            if signals_df["signal"].iloc[i] == 1 and position_size == 0:
                ...
                if entry_price > sl_price:
                    ...
                    if size * entry_price <= cash:
                        ...
                        logging.debug(
                            f"Entry triggered at {entry_price}, size {position_size}, SL {stop_loss}"
                        )
                    else:
    ...
    def _calculate_per_regime_metrics(
        self, trades_list: list, regime_data: dict, initial_capital: float
    ) -> dict:
        ...
        for regime, data in regime_metrics.items():
            ...
            summary[regime] = {
                ...
                "return_pct": (data["total_pnl"] / initial_capital * 100)
    ...
    def rapid_backtest(
        self, symbol: str, end_date: str, params: dict, window_days=7
    ) -> BacktestResult:
