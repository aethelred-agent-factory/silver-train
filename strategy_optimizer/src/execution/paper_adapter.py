...
class PaperAdapter:
    ...
    def create_order(self, order_id: str, symbol: str, order_type: str, side: str, amount: float, price: float = None) -> Dict[str, Any]:
        if price is None:
            raise ValueError("Paper trading simulation requires a price for all orders.")
