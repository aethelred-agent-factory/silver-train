    ...
    if os.path.exists(path):
        with open(path, 'rt') as f:
            try:
                ...
                logging.warning(f"Error in Logging Configuration. Using default configs: {e}")
    else:
        logging.basicConfig(level=default_level)
        logging.warning('Failed to load logging configuration file. Using default configs')
