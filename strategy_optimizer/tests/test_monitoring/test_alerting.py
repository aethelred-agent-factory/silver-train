...
def test_send_urgent_alert(alerting, mocker):
    ...
    mock_send_email.assert_called_once_with("URGENT ALERT: Strategy Optimizer", "Critical issue detected!")
...
def test_send_daily_summary(alerting, mocker):
    ...
    mock_send_email.assert_called_once_with("Daily Performance Summary", "Equity up 1.5%")
