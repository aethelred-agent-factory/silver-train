...
def emergency_shutdown(reason: str):
    ...
    emergency_manager.trigger_emergency(
        incident_type="MANUAL_SHUTDOWN", details=f"Manual intervention: {reason}"
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Initiate an emergency shutdown of the strategy optimizer."
    )
    parser.add_argument(
        "--reason", type=str, required=True, help="Reason for the emergency shutdown."
    )
